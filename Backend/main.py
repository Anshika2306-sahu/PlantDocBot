...
# 1. Changed 'file' to 'image_file' to match the React code
async def image_predict(image_file: UploadFile = File(...)): 
    # Read the image file
    ...
    # 2. Changed the response to match what the React code expects
    return {
        "class": predicted_class,
        "confidence": confidence_score  # Send as a number
    }
# -----------------------------
